...
| `poiseuille_W` (general analytical solution) | `sim_non-Newtonian/sim_nonnewtonian_poiseuille.cu` | 69–75 |
| `CY_Constitutive` struct | `sim_non-Newtonian/sim_nonnewtonian_poiseuille.cu` | 94–120 |
| `Casson_Constitutive` struct | `sim_non-Newtonian/sim_nonnewtonian_poiseuille.cu` | 122–150 |
| Power-law analytical solution | `sim_non-Newtonian/sim_nonnewtonian_poiseuille.cu` | 256–262 |
| CY analytical solution | `sim_non-Newtonian/sim_nonnewtonian_poiseuille.cu` | 264–286 |
| Casson analytical solution | `sim_non-Newtonian/sim_nonnewtonian_poiseuille.cu` | 288–307 |
| Unit conversions and non-dimensionalization | `sim_non-Newtonian/sim_nonnewtonian_poiseuille.cu` | 630–685 (PL), 686–768 (CY), 769–830 (Casson) |
