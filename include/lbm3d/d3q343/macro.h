...
template <typename TRAITS>
struct D3Q343_MACRO_Default : D3Q343_MACRO_Base<TRAITS>
{
	using dreal = typename TRAITS::dreal;
	using idx = typename TRAITS::idx;
...
template <typename TRAITS>
struct D3Q343_MACRO_Mean : D3Q343_MACRO_Base<TRAITS>
{
	using dreal = typename TRAITS::dreal;
	using idx = typename TRAITS::idx;
...
template <typename TRAITS>
struct D3Q343_MACRO_Void : D3Q343_MACRO_Base<TRAITS>
{
	using dreal = typename TRAITS::dreal;
	using idx = typename TRAITS::idx;
