...
void export_State(nb::module_& m, const char* name)
{
	...
	// TODO: uncomment when rebased on main
	//export_typedef<typename State::bool3d>(state, "bool3d");
