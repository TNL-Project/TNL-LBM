...
struct D3Q27_CLBM : D3Q27_COMMON<TRAITS, LBM_EQ>
{
	...
	__cuda_callable__ static void collision(LBM_KS& KS)
	{
		...
		// derivatives of v: notation taken from Geier's paper 2015 https://doi.org/10.1016/j.camwa.2015.05.001
		// Appendix D, Eq D.1-3
		...
		const dreal EqD6RHS = KS.rho * omega2 + (no1 - omega2) * (k_200 + k_020 + k_002)
		...
		const dreal EqD16RHS = (no1 - omega7) * (k_220 + k_202 + k_022) + omega7 * KS.rho * n1o3;
		...
		const dreal ks_222 = (no1 - omega10) * k_222 + omega10 * KS.rho * n1o27;
		...
		const dreal m_17 = (no6 * KS.vy * KS.vy + no6 * KS.vz * KS.vz - no8) * KS.vx * KS.fx
						 + (no6 * KS.vx * KS.vx * KS.vy + no6 * KS.vy * KS.vz * KS.vz - no8 * KS.vy) * KS.fy
						 + (no6 * KS.vx * KS.vx * KS.vz + 6 * KS.vy * KS.vy * KS.vz - no8 * KS.vz) * KS.fz;
		const dreal m_18 = (no6 * KS.vy * KS.vy + no6 * KS.vz * KS.vz - no8) * KS.vx * KS.fx
						 + (no6 * KS.vx * KS.vx * KS.vy - no12 * KS.vy * KS.vz * KS.vz + no4 * KS.vy) * KS.fy
						 + (no6 * KS.vx * KS.vx * KS.vz - no12 * KS.vy * KS.vy * KS.vz + no4 * KS.vz) * KS.fz;
		const dreal m_19 = (no6 * KS.vy * KS.vy - no6 * KS.vz * KS.vz) * KS.vx * KS.fx + (no6 * KS.vx * KS.vx * KS.vy - no4 * KS.vy) * KS.fy
						 + (-no6 * KS.vx * KS.vx * KS.vz + no4 * KS.vz) * KS.fz;
		const dreal m_20 = no6 * KS.vx * KS.vy * KS.vz * KS.fx + (no3 * KS.vx * KS.vx * KS.vz - no2 * KS.vz) * KS.fy
						 + (no3 * KS.vx * KS.vx * KS.vy - no2 * KS.vy) * KS.fz;
		const dreal m_21 = (no3 * KS.vy * KS.vy * KS.vz - no2 * KS.vz) * KS.fx + no6 * KS.vx * KS.vy * KS.vz * KS.fy
						 + (no3 * KS.vx * KS.vy * KS.vy - no2 * KS.vx) * KS.fz;
		const dreal m_22 = (no3 * KS.vy * KS.vz * KS.vz - no2 * KS.vy) * KS.fx + (no3 * KS.vx * KS.vz * KS.vz - no2 * KS.vx) * KS.fy
						 + no6 * KS.vx * KS.vy * KS.vz * KS.fz;
		const dreal m_23 = ((no9 * KS.vz * KS.vz - no6) * KS.vy * KS.vy - no6 * KS.vz * KS.vz + no4) * KS.fx
						 + (no18 * KS.vz * KS.vz - no12) * KS.vy * KS.vx * KS.fy + no6 * KS.vx * KS.vz * (no3 * KS.vy * KS.vy - no2) * KS.fz;
		const dreal m_24 = (no18 * KS.vz * KS.vz - no12) * KS.vy * KS.vx * KS.fx
						 + ((no9 * KS.vz * KS.vz - no6) * KS.vx * KS.vx - no6 * KS.vz * KS.vz + no4) * KS.fy
						 + no6 * KS.vz * KS.vy * (no3 * KS.vx * KS.vx - no2) * KS.fz;
		const dreal m_25 = no6 * KS.vx * KS.vz * (no3 * KS.vy * KS.vy - no2) * KS.fx + no6 * KS.vz * KS.vy * (no3 * KS.vx * KS.vx - no2) * KS.fy
						 + ((no9 * KS.vy * KS.vy - no6) * KS.vx * KS.vx - no6 * KS.vy * KS.vy + no4) * KS.fz;
		const dreal m_26 = (no6 * (no3 * KS.vz * KS.vz - no2)) * (no3 * KS.vy * KS.vy - no2) * KS.vx * KS.fx
						 + (no6 * (no3 * KS.vz * KS.vz - no2)) * (no3 * KS.vx * KS.vx - no2) * KS.vy * KS.fy
						 + no6 * KS.vz * (no3 * KS.vx * KS.vx - no2) * (no3 * KS.vy * KS.vy - no2) * KS.fz;
		...
		const dreal S_3 =
			n1o108 * (no4 * m_0 + no6 * m_2 - no9 * m_7 + no3 * m_8 - no6 * m_9 - no6 * m_11 + no3 * m_18 - no9 * m_19 + no6 * m_24 + no2 * m_26);
		const dreal S_4 =
			n1o108 * (no4 * m_0 - no6 * m_2 - no9 * m_7 + no3 * m_8 - no6 * m_9 + no6 * m_11 + no3 * m_18 - no9 * m_19 - no6 * m_24 + no2 * m_26);
		...
		const dreal S_7 = n1o216
						* (no8 * m_0 + no12 * m_1 + no12 * m_2 + no18 * m_4 + no12 * m_8 - no3 * m_10 - no3 * m_11 + no27 * m_13 + no27 * m_14
						   - no6 * m_17 + no3 * m_18 + no9 * m_19 - no18 * m_22 - no6 * m_23 - no6 * m_24 - no2 * m_26);
		const dreal S_8 = n1o216
						* (no8 * m_0 - no12 * m_1 + no12 * m_2 - no18 * m_4 + no12 * m_8 + no3 * m_10 - no3 * m_11 - no27 * m_13 + no27 * m_14
						   - no6 * m_17 + no3 * m_18 + no9 * m_19 + no18 * m_22 + no6 * m_23 - no6 * m_24 - no2 * m_26);
		const dreal S_9 = n1o216
						* (no8 * m_0 + no12 * m_1 - no12 * m_2 - no18 * m_4 + no12 * m_8 - no3 * m_10 + no3 * m_11 + no27 * m_13 - no27 * m_14
						   - no6 * m_17 + no3 * m_18 + no9 * m_19 + no18 * m_22 - no6 * m_23 + no6 * m_24 - no2 * m_26);
		const dreal S_10 = n1o216
						 * (no8 * m_0 - no12 * m_1 - no12 * m_2 + no18 * m_4 + no12 * m_8 + no3 * m_10 + no3 * m_11 - no27 * m_13 - no27 * m_14
							- no6 * m_17 + no3 * m_18 + no9 * m_19 - no18 * m_22 + no6 * m_23 + no6 * m_24 - no2 * m_26);
		const dreal S_11 = n1o216
						 * (no8 * m_0 + no12 * m_1 + no12 * m_3 + no18 * m_5 + no18 * m_7 - no6 * m_8 - no3 * m_10 - no3 * m_12 - no27 * m_13
							+ no27 * m_15 - no6 * m_17 + no3 * m_18 - no9 * m_19 - no18 * m_21 - no6 * m_23 - no6 * m_25 - no2 * m_26);
		const dreal S_12 = n1o216
						 * (no8 * m_0 - no12 * m_1 + no12 * m_3 - no18 * m_5 + no18 * m_7 - no6 * m_8 + no3 * m_10 - no3 * m_12 + no27 * m_13
							+ no27 * m_15 - no6 * m_17 + no3 * m_18 - no9 * m_19 + no18 * m_21 + no6 * m_23 - no6 * m_25 - no2 * m_26);
		const dreal S_13 = n1o216
						 * (no8 * m_0 + no12 * m_1 - no12 * m_3 - no18 * m_5 + no18 * m_7 - no6 * m_8 - no3 * m_10 + no3 * m_12 - no27 * m_13
							- no27 * m_15 - no6 * m_17 + no3 * m_18 - no9 * m_19 + no18 * m_21 - no6 * m_23 + no6 * m_25 - no2 * m_26);
		const dreal S_14 = n1o216
						 * (no8 * m_0 - no12 * m_1 - no12 * m_3 + no18 * m_5 + no18 * m_7 - no6 * m_8 + no3 * m_10 + no3 * m_12 + no27 * m_13
							- no27 * m_15 - no6 * m_17 + no3 * m_18 - no9 * m_19 - no18 * m_21 + no6 * m_23 + no6 * m_25 - no2 * m_26);
		const dreal S_15 = n1o216
						 * (no8 * m_0 + no12 * m_2 + no12 * m_3 + no18 * m_6 - no18 * m_7 - no6 * m_8 - no3 * m_11 - no3 * m_12 - no27 * m_14
							- no27 * m_15 - no6 * m_17 - no6 * m_18 - no18 * m_20 - no6 * m_24 - no6 * m_25 - no2 * m_26);
		const dreal S_16 = n1o216
						 * (no8 * m_0 - no12 * m_2 + no12 * m_3 - no18 * m_6 - no18 * m_7 - no6 * m_8 + no3 * m_11 - no3 * m_12 + no27 * m_14
							- no27 * m_15 - no6 * m_17 - no6 * m_18 + no18 * m_20 + no6 * m_24 - no6 * m_25 - no2 * m_26);
		const dreal S_17 = n1o216
						 * (no8 * m_0 + no12 * m_2 - no12 * m_3 - no18 * m_6 - no18 * m_7 - no6 * m_8 - no3 * m_11 + no3 * m_12 - no27 * m_14
							+ no27 * m_15 - no6 * m_17 - no6 * m_18 + no18 * m_20 - no6 * m_24 + no6 * m_25 - no2 * m_26);
		const dreal S_18 = n1o216
						 * (no8 * m_0 - no12 * m_2 - no12 * m_3 + no18 * m_6 - no18 * m_7 - no6 * m_8 + no3 * m_11 + no3 * m_12 + no27 * m_14
							+ no27 * m_15 - no6 * m_17 - no6 * m_18 - no18 * m_20 + no6 * m_24 + no6 * m_25 - no2 * m_26);
		const dreal S_19 =
			n1o216
			* (no8 * m_0 + no12 * m_1 + no12 * m_2 + no12 * m_3 + no18 * m_4 + no18 * m_5 + no18 * m_6 + no12 * m_9 + no6 * m_10 + no6 * m_11
			   + no6 * m_12 + no27 * m_16 + no6 * m_17 + no9 * m_20 + no9 * m_21 + no9 * m_22 + no3 * m_23 + no3 * m_24 + no3 * m_25 + m_26);
		const dreal S_20 =
			n1o216
			* (no8 * m_0 - no12 * m_1 + no12 * m_2 + no12 * m_3 - no18 * m_4 - no18 * m_5 + no18 * m_6 + no12 * m_9 - no6 * m_10 + no6 * m_11
			   + no6 * m_12 - no27 * m_16 + no6 * m_17 + no9 * m_20 - no9 * m_21 - no9 * m_22 - no3 * m_23 + no3 * m_24 + no3 * m_25 + m_26);
