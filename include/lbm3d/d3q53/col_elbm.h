...
F[3] = -2*A*(B1*B1)*(B2*B2)*(B3*B3*B3*B3*B3*B3*B3*B3)*LBM_KS::id_to_weight(49) - 2*A*(B1*B1)*(B2*B2)*(B3*B3*B3*B3*B3*B3*B3*B3)*LBM_KS::id_to_weight(50) - 2*A*(B1*B1)*(B2*B2)*(B3*B3*B3*B3*B3*B3*B3*B3)*LBM_KS::id_to_weight(51) + 2*A*(B1*B1)*(B3*B3*B3*B3*B3*B3*B3*B3)*LBM_KS::id_to_weight(44)/(B2*B2) + 2*A*(B1*B1)*(B3*B3*B3*B3*B3*B3*B3*B3)*LBM_KS::id_to_weight(45)/(B2*B2) + 2*A*(B1*B1)*(B3*B3*B3*B3*B3*B3*B3*B3)*LBM_KS::id_to_weight(46)/(B2*B2) - A*B1*B2*(B3*B3)*LBM_KS::id_to_weight(41) - A*B1*B2*(B3*B3)*LBM_KS::id_to_weight(42) - A*B1*B2*(B3*B3)*LBM_KS::id_to_weight(43) + A*B1*(B3*B3)*LBM_KS::id_to_weight(35)/B2 + A*B1*(B3*B3)*LBM_KS::id_to_weight(36)/B2 + A*B1*(B3*B3)*LBM_KS::id_to_weight(37)/B2 - 3*A*(B2*B2*B2)*(B3*B3*B3*B3*B3*B3*B3*B3*B3)*LBM_KS::id_to_weight(34) - 2*A*(B2*B2)*(B3*B3*B3*B3)*LBM_KS::id_to_weight(32) - 2*A*(B2*B2)*(B3*B3*B3*B3)*LBM_KS::id_to_weight(33) - A*B2*B3*LBM_KS::id_to_weight(29) - A*B2*B3*LBM_KS::id_to_weight(30) - A*B2*B3*LBM_KS::id_to_weight(31) + A*B3*LBM_KS::id_to_weight(21)/B2 + A*B3*LBM_KS::id_to_weight(22)/B2 + A*B3*LBM_KS::id_to_weight(23)/B2 + 2*A*(B3*B3*B3*B3)*LBM_KS::id_to_weight(19)/(B2*B2) + 2*A*(B3*B3*B3*B3)*LBM_KS::id_to_weight(20)/(B2*B2) + 3*A*(B3*B3*B3*B3*B3*B3*B3*B3*B3)*LBM_KS::id_to_weight(18)/(B2*B2*B2) - A*B2*(B3*B3)*LBM_KS::id_to_weight(15)/B1 - A*B2*(B3*B3)*LBM_KS::id_to_weight(16)/B1 - A*B2*(B3*B3)*LBM_KS::id_to_weight(17)/B1 + A*(B3*B3)*LBM_KS::id_to_weight(10)/(B1*B2) + A*(B3*B3)*LBM_KS::id_to_weight(11)/(B1*B2) + A*(B3*B3)*LBM_KS::id_to_weight(9)/(B1*B2) - 2*A*(B2*B2)*(B3*B3*B3*B3*B3*B3*B3*B3)*LBM_KS::id_to_weight(6)/(B1*B1) - 2*A*(B2*B2)*(B3*B3*B3*B3*B3*B3*B3*B3)*LBM_KS::id_to_weight(7)/(B1*B1) - 2*A*(B2*B2)*(B3*B3*B3*B3*B3*B3*B3*B3)*LBM_KS::id_to_weight(8)/(B1*B1) + 2*A*(B3*B3*B3*B3*B3*B3*B3*B3)*LBM_KS::id_to_weight(1)/((B1*B1)*(B2*B2)) + 2*A*(B3*B3*B3*B3*B3*B3*B3*B3)*LBM_KS::id_to_weight(2)/((B1*B1)*(B2*B2)) + 2*A*(B3*B3*B3*B3*B3*B3*B3*B3)*LBM_KS::id_to_weight(3)/((B1*B1)*(B2*B2)) + KS.rho*KS.vz;
    ...
    __cuda_callable__ static void calculateEquilibriumDistribution(dreal (&feq)[LBM_KS::Q], dreal &A, dreal &B1, dreal &B2, dreal &B3, LBM_KS &KS){
        ...
        {
        feq[0] = A*B3*B3*B3*B3*B3*B3*B3*B3*B3*LBM_KS::id_to_weight(0)/(B1*B1*B1);
		feq[1] = A*B3*B3*B3*B3*B3*B3*B3*B3*LBM_KS::id_to_weight(1)/(B1*B1*B2*B2);
		feq[2] = A*B3*B3*B3*B3*B3*B3*B3*B3*LBM_KS::id_to_weight(2)/(B1*B1*B2*B2);
		feq[3] = A*B3*B3*B3*B3*B3*B3*B3*B3*LBM_KS::id_to_weight(3)/(B1*B1*B2*B2);
		feq[4] = A*B3*B3*B3*B3*LBM_KS::id_to_weight(4)/(B1*B1);
		feq[5] = A*B3*B3*B3*B3*LBM_KS::id_to_weight(5)/(B1*B1);
		feq[6] = A*B2*B2*B3*B3*B3*B3*B3*B3*B3*B3*LBM_KS::id_to_weight(6)/(B1*B1);
		feq[7] = A*B2*B2*B3*B3*B3*B3*B3*B3*B3*B3*LBM_KS::id_to_weight(7)/(B1*B1);
		feq[8] = A*B2*B2*B3*B3*B3*B3*B3*B3*B3*B3*LBM_KS::id_to_weight(8)/(B1*B1);
		feq[9] = A*B3*B3*LBM_KS::id_to_weight(9)/(B1*B2);
		feq[10] = A*B3*B3*LBM_KS::id_to_weight(10)/(B1*B2);
		feq[11] = A*B3*B3*LBM_KS::id_to_weight(11)/(B1*B2);
		feq[12] = A*B3*LBM_KS::id_to_weight(12)/B1;
		feq[13] = A*B3*LBM_KS::id_to_weight(13)/B1;
		feq[14] = A*B3*LBM_KS::id_to_weight(14)/B1;
		feq[15] = A*B2*B3*B3*LBM_KS::id_to_weight(15)/B1;
		feq[16] = A*B2*B3*B3*LBM_KS::id_to_weight(16)/B1;
		feq[17] = A*B2*B3*B3*LBM_KS::id_to_weight(17)/B1;
		feq[18] = A*B3*B3*B3*B3*B3*B3*B3*B3*B3*LBM_KS::id_to_weight(18)/(B2*B2*B2);
		feq[19] = A*B3*B3*B3*B3*LBM_KS::id_to_weight(19)/(B2*B2);
		feq[20] = A*B3*B3*B3*B3*LBM_KS::id_to_weight(20)/(B2*B2);
		feq[21] = A*B3*LBM_KS::id_to_weight(21)/B2;
		feq[22] = A*B3*LBM_KS::id_to_weight(22)/B2;
		feq[23] = A*B3*LBM_KS::id_to_weight(23)/B2;
		feq[24] = A*LBM_KS::id_to_weight(24);
		feq[25] = A*LBM_KS::id_to_weight(25);
		feq[26] = A*LBM_KS::id_to_weight(26);
		feq[27] = A*LBM_KS::id_to_weight(27);
		feq[28] = A*LBM_KS::id_to_weight(28);
		feq[29] = A*B2*B3*LBM_KS::id_to_weight(29);
		feq[30] = A*B2*B3*LBM_KS::id_to_weight(30);
		feq[31] = A*B2*B3*LBM_KS::id_to_weight(31);
		feq[32] = A*B2*B2*B3*B3*B3*B3*LBM_KS::id_to_weight(32);
		feq[33] = A*B2*B2*B3*B3*B3*B3*LBM_KS::id_to_weight(33);
		feq[34] = A*B2*B2*B2*B3*B3*B3*B3*B3*B3*B3*B3*B3*LBM_KS::id_to_weight(34);
		feq[35] = A*B1*B3*B3*LBM_KS::id_to_weight(35)/B2;
		feq[36] = A*B1*B3*B3*LBM_KS::id_to_weight(36)/B2;
		feq[37] = A*B1*B3*B3*LBM_KS::id_to_weight(37)/B2;
		feq[38] = A*B1*B3*LBM_KS::id_to_weight(38);
		feq[39] = A*B1*B3*LBM_KS::id_to_weight(39);
		feq[40] = A*B1*B3*LBM_KS::id_to_weight(40);
		feq[41] = A*B1*B2*B3*B3*LBM_KS::id_to_weight(41);
		feq[42] = A*B1*B2*B3*B3*LBM_KS::id_to_weight(42);
		feq[43] = A*B1*B2*B3*B3*LBM_KS::id_to_weight(43);
		feq[44] = A*B1*B1*B3*B3*B3*B3*B3*B3*B3*B3*LBM_KS::id_to_weight(44)/(B2*B2);
		feq[45] = A*B1*B1*B3*B3*B3*B3*B3*B3*B3*B3*LBM_KS::id_to_weight(45)/(B2*B2);
		feq[46] = A*B1*B1*B3*B3*B3*B3*B3*B3*B3*B3*LBM_KS::id_to_weight(46)/(B2*B2);
		feq[47] = A*B1*B1*B3*B3*B3*B3*LBM_KS::id_to_weight(47);
		feq[48] = A*B1*B1*B3*B3*B3*B3*LBM_KS::id_to_weight(48);
		feq[49] = A*B1*B1*B2*B2*B3*B3*B3*B3*B3*B3*B3*B3*LBM_KS::id_to_weight(49);
		feq[50] = A*B1*B1*B2*B2*B3*B3*B3*B3*B3*B3*B3*B3*LBM_KS::id_to_weight(50);
		feq[51] = A*B1*B1*B2*B2*B3*B3*B3*B3*B3*B3*B3*B3*LBM_KS::id_to_weight(51);
		feq[52] = A*B1*B1*B1*B3*B3*B3*B3*B3*B3*B3*B3*B3*LBM_KS::id_to_weight(52);
        }
    }
