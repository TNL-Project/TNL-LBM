...
template <typename TRAITS>
struct D3Q53_MACRO_Default : D3Q53_MACRO_Base<TRAITS>
{
	using dreal = typename TRAITS::dreal;
	using idx = typename TRAITS::idx;
...
template <typename TRAITS>
struct D3Q53_MACRO_Mean : D3Q53_MACRO_Base<TRAITS>
{
	using dreal = typename TRAITS::dreal;
	using idx = typename TRAITS::idx;
...
template <typename TRAITS>
struct D3Q53_MACRO_Void : D3Q53_MACRO_Base<TRAITS>
{
	using dreal = typename TRAITS::dreal;
	using idx = typename TRAITS::idx;
