...
template <typename TRAITS>
using D3Q7_STREAMING = D3Q7_STREAMING_AB_PUSH<TRAITS>;
#elif defined(TNL_LBM_STREAMING_PATTERN_ESO_PULL)
template <typename TRAITS>
using D3Q7_STREAMING = D3Q7_STREAMING_ESO_PULL<TRAITS>;
#elif defined(TNL_LBM_STREAMING_PATTERN_ESO_PUSH)
template <typename TRAITS>
using D3Q7_STREAMING = D3Q7_STREAMING_ESO_PUSH<TRAITS>;
#elif defined(TNL_LBM_STREAMING_PATTERN_ESO_TWIST)
template <typename TRAITS>
using D3Q7_STREAMING = D3Q7_STREAMING_ESO_TWIST<TRAITS>;
#else
